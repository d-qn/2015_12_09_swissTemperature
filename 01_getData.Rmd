...
plot.intro <- function(df, plot.title, average, y.range, monthly.average.label, overall.average.label) {
...
render.gif <- function(
  data, stations, plot.title, monthly.average.label, overall.average.label, output.file = paste0("swissTemperature_", paste(stations, collapse ="_"), ".gif")
  ) {
  ...
  saveGIF({
    bg.p <- plot.intro(df, plot.title, average, y.range, monthly.average.label, overall.average.label)
